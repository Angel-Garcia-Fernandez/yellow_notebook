...
Paperclip.options[:content_type_mappings] = {
    xls: ['application/vnd.ms-excel', 'text/csv', 'text/plain', 'text/comma-separated-values'],
    xlsx: ['application/vnd.ms-excel', 'text/csv', 'text/plain', 'text/comma-separated-values']
}